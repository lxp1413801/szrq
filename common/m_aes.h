...
extern uint16_t m_ebc_encrypt(uint8_t* output, uint8_t* input, uint8_t* key,uint16_t length);
//extern uint16_t m_ebc_decrypt(uint8_t* output, uint8_t* input, uint8_t* key,uint16_t length);
extern uint16_t m_ebc_decrypt(uint8_t* output, uint8_t* input, uint8_t* key,uint16_t length);
